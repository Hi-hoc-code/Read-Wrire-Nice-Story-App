...
public class TinhYeuAdapter extends RecyclerView.Adapter<TinhYeuAdapter.MyViewHoler> {
    Context context;
    ArrayList<Book> list;

    public TinhYeuAdapter(Context context, ArrayList<Book> list) {
    ...
    @NonNull
    @Override
    public TinhYeuAdapter.MyViewHoler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_item_view_book, parent, false);
        return new TinhYeuAdapter.MyViewHoler(view);
    }

    @Override
    public void onBindViewHolder(@NonNull TinhYeuAdapter.MyViewHoler holder, int position) {
