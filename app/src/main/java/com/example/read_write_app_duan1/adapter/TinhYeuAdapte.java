...
public class TinhYeuAdapte  extends RecyclerView.Adapter<TinhYeuAdapte.MyViewHoler> {
    Context context;
    ArrayList<Book> list;

    public TinhYeuAdapte(Context context, ArrayList<Book> list) {
    ...
    @NonNull
    @Override
    public TinhYeuAdapte.MyViewHoler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_item_recommend_story, parent, false);
        return new TinhYeuAdapte.MyViewHoler(view);
    }

    @Override
    public void onBindViewHolder(@NonNull TinhYeuAdapte.MyViewHoler holder, int position) {
